...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="?page=utama">SI Pemesanan Obat di Apotek Sehat Tanjungbalai</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="?page=pemesanan&actions=tampil">Data Pemesanan</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
						...
						<li><a href="?page=laporanpemesanan&actions=report">Laporan Pemesanan</a></li>
                    </ul>
                </li>
