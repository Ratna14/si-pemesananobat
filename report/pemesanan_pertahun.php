...
<html>
    <head>
        <title>Cetak Data Pemesanan Pertahun</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <h4>Jalan Jendral Sudirman, 27. <br> Tanjungbalai, Sumatera Utara, 21231</h4>
                        <hr>
                        <h3>DATA PEMESANAN OBAT TAHUN   <? echo "$ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM pemesanan WHERE substr(tanggal_masuk,1,4)='$ambilthn'";
