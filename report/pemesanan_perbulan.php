...
<html>
    <head>
        <title>Cetak Data Pemesanan Obat Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA PEMESANAN OBAT BULAN <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM pemesanan WHERE substr(tanggal_masuk,1,7)='$ambilthn-$ambilbln'";
